...
export default function Summary() {
  ...
  const data = {
    ...
    revenueToday: { value: "8.48K", unit: "", hasInfo: true },
  ...
  return (
    ...
    <div className="bg-gray-100 mt-5 rounded-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 mt-2">
        ...
        <Card title="Revenue today" {...data.revenueToday} />
        <Card title="Total yield" {...data.totalYield} />
        <Card title="Inventor rated power" {...data.inventorRatedPower} />
        <Card title="Rate ESS capacity" {...data.rateEssCapacity} />
        <Card title="Supply from grid today" {...data.supplyFromGrid} />
      </div>
