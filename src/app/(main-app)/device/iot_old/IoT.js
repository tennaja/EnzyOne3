...
export default function IoT({ companyId = 2 }) {
  ...
  const [deviceParameter, setDeviceParameter] = useState([
    {
      deviceTypeID: "1",
      deviceTypeName: "Air Compressor",
      parameter: ["Pressure (psi)", "Performance", "Running Hours"],
    },
  ]);
