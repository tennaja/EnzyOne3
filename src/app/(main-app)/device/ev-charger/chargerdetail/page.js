...
const ChargerDetail = () => {
  ...
  // รับค่า chargerId และ siteName จาก Query Parameters หรือ Local Storage
  const chargerId = searchParams.get('chargerId') || localStorage.getItem('chargerId') || 'default-charger-id';
  ...
  const handleChargerHeadClick = (chargerHeadId, chargerHeadName) => {
    ...
    // Navigate to ChargerHeadDetail page
