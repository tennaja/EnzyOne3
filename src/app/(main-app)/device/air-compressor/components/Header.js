...
switch (activeTab) {
case "dashboard":
return <Dashboard deviceData={data}/>;
case "control":
...
<button className="text-white bg-[#33BFBF] rounded-md text-lg px-10 h-9">Search</button>
</div>
</div>
...
<p className="text-sm mb-4">Egat | ลานจอดรถชั้น 2</p>
