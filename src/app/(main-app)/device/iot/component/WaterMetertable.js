...
export default function WaterMetertable(Watermeterlist) {
    ...
    <div className="grid rounded-xl bg-white p-3 shadow-default dark:border-slate-800 dark:bg-dark-box dark:text-slate-200 my-5">
        <div className="flex flex-col gap-4 p-2">
          <div className="flex justify-between">
            <span className="text-lg  font-bold">Water Meter</span>
            <input
              type="text"
              placeholder="ค้นหา"
        ...
        <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8 ">
          <div className="overflow-x-auto">
            <table className="min-w-full text-left text-sm font-light">
              ...
              <tbody>
                {Watermeterlist.Watermeterlist.length > 0 &&
                  Watermeterlist.Watermeterlist.filter((item) => {
                    // let data = []
                    ...
                    return (
                      ...
                      String(item.flow).includes(searchTable) 
                    ...
                    return (
                      ...
                      >
                        ...
                        <Highlighter
                                    ...
                                    searchWords={[searchTable]}
                                    autoEscape={true}
                                    textToHighlight={String(item.flow)} // Replace this with your text
                                  />
