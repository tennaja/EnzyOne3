...
export default function FloorPlan({ FloorId }) {
  ...
  const [showModalAutomationAHUOn, setShowModalAutomationAHUOn] =
    useState(false);
  const [showModalAutomationAHUOff, setShowModalAutomationAHUOff] =
    useState(false);
  ...
  const getfloorplan = async (floorId) => {
    ...
    result.data.map((item) => {
      setdeviceTypeList(item.deviceType);
      setOption(item.deviceType[0].displayName);
    });
  ...
  return (
    <div>
                                      ...
                                      <span
                                        className={
                                          marker.status == "on"
                                            ...
                                            : marker.status == "offline"
                                            ? " text-center text-red-500 font-extrabold"
            ...
            <div className="p-8 border w-auto shadow-lg rounded-md bg-white">
              ...
              <div className="flex justify-center mt-10 gap-5">
                ...
                <button
                  ...
                  onClick={() => {
                    handleChangeValueSettemp(DecviceId, Values, DevId);
                    setOpenSettempModal(false);
                  }}
                >
                  Confirm
            ...
            <div className="p-8 border w-auto shadow-lg rounded-md bg-white">
              ...
              <div className="flex justify-center mt-8 gap-5">
                ...
                <button
                  className="px-4 py-2 bg-[#14b8a6] text-white font-medium rounded-md  focus:outline-none"
                  onClick={() => {
                    handleChangeValueSetFan(DecviceId, Values, DevId);
                    setOpenSetModeModal(false);
                  }}
                >
                  Confirm
            ...
            <div className="p-8 border w-auto shadow-lg rounded-md bg-white">
              ...
              <div className="flex justify-center mt-8 gap-5">
                ...
                <button
                  className="px-4 py-2 bg-[#14b8a6] text-white font-medium rounded-md  focus:outline-none"
                  onClick={() => {
                    handleChangeValueSetMode(DecviceId, Values, DevId);
                    setOpenSetFanModal(false);
                  }}
                >
                  Confirm
            ...
            <div className="p-8 border w-auto shadow-lg rounded-md bg-white">
              ...
              <div className="flex justify-center mt-10 gap-5">
                ...
                <button
                  className="px-4 py-2 bg-[#14b8a6] text-white font-medium rounded-md  focus:outline-none"
                  onClick={() => {
                    handleChangeValueSettempVav(DecviceId, Values, DevId);
                    setOpenSettempModalVAV(false);
                  }}
                >
                  Confirm
            ...
            <div className="p-8 border w-auto shadow-lg rounded-md bg-white">
              ...
              <div className="flex justify-center mt-10 gap-5">
                ...
                <button
                  className="px-4 py-2 bg-[#14b8a6] text-white font-medium rounded-md  focus:outline-none"
                  onClick={() => {
                    handleChangeValueSettempAHU(DecviceId, Values, DevId);
                    setOpenSettempModalAHU(false);
                  }}
                >
                  Confirm
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center mt-10 gap-5">
                  ...
                  <button
                    className="px-4 py-2 bg-[#14b8a6] text-white font-medium rounded-md  focus:outline-none"
                    onClick={() => {
                      clickChangestatusControle(DecviceId, Values, DevId);
                      setShowModalControleOn(false);
                    }}
                  >
                    Confirm
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center mt-10 gap-5">
                  ...
                  <button
                    className="px-4 py-2 bg-[#14b8a6] text-white font-medium rounded-md  focus:outline-none"
                    onClick={() => {
                      clickChangestatusAutomation(DecviceId, Values, DevId);
                      setShowModalAutomationAHUOn(false);
                    }}
                  >
                    Confirm
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center mt-10 gap-5">
                  ...
                  <button
                    className="px-4 py-2 bg-[#14b8a6] text-white font-medium rounded-md  focus:outline-none"
                    onClick={() => {
                      clickChangestatusAutomationAHU(DecviceId, Values, DevId);
                      setShowModalAutomationAHUOn(false);
                    }}
                  >
                    Confirm
      ...
      <SplitTypetable
        ...
        onSubmitControl={clickChangestatusControle}
        onSubmitSettemp={handleChangeValueSettemp}
        onSubmitSetMode={handleChangeValueSetMode}
        onSubmitSetFan={handleChangeValueSetFan}
        onSubmitAutomation={clickChangestatusAutomation}
      />
      {/* ปิดตาราง AHU, VAV */}
      {/*  <AHUtable
        AHUlist={AHUList}
        onSubmitAutomation={clickChangestatusAutomationAHU}
        onSubmitSettemp={handleChangeValueSettempAHU}
      />
      <VAVtable
        VAVList={VAVList}
        onSubmitSettemp={handleChangeValueSettempVav}
      /> */}
